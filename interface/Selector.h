...
public:
	...
	std::vector<int> TausLoose;
	std::vector<int> TausMedium;
	std::vector<int> TausTight;
	std::vector<int> Taus;
	...
	//Taus Added for Tau Analysis
	double tau_Pt_cut;
        double tau_Eta_cut;
	int tau_vsJet_cut;
	int tau_vsJet_cut_loose;
	int tau_vsJet_cut_medium;
	int tau_vsJet_cut_tight;
	int tau_vsEle_cut;
	int tau_vsMu_cut;
	double tau_d0_cut;
	double tau_dz_cut;
	...
	void filter_taus(EventTree* tr); //Added for Tau Analysis
	void filter_jets(int tauId_1, int tauId_2);
	//void filter_jets();
...
public:
        ...
        std::vector<int> MuonsLoose;
        std::vector<int> MuonsNoIso;
	std::vector<int> Taus; // Added for Tau Analysis
        std::vector<int> Jets;
        std::vector<int> bJets;
        std::vector<int> FwdJets;
        std::vector<double> MuRelIso_corr;
	...
	EventTree* tree;
        ...
        void filter_muons();
	void filter_taus(); //Added for Tau Analysis
        void filter_jets();
	 double eleEffArea03(double SCEta);
        double muEffArea04(double muEta);
